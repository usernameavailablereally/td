...
namespace MoreMountains.TopDownEngine
{
	...
	/// </summary>
	[RequireComponent(typeof(MMConeOfVisionCustom))]
	[AddComponentMenu("TopDown Engine/Character/Abilities/Character Cone of Vision Custom")]
	public class CharacterConeOfVisionCustom : TopDownMonoBehaviour
	{
		protected MMConeOfVisionCustom _coneOfVision;
		...
		protected virtual void Awake()
		{
			...
			_coneOfVision = this.gameObject.GetComponent<MMConeOfVisionCustom>();
		}
