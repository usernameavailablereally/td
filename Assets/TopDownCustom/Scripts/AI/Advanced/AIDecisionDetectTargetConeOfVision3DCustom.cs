...
namespace MoreMountains.TopDownEngine
{
	...
	/// </summary>
	[AddComponentMenu("TopDown Engine/Character/AI/Decisions/AIDecisionDetectTargetConeOfVision3DCustom")]
	public class AIDecisionDetectTargetConeOfVision3DCustom : AIDecision
	{
		...
		public MMConeOfVisionCustom TargetConeOfVision;
		...
		public override void Initialization()
		{
			...
			{
				TargetConeOfVision = this.gameObject.GetComponent<MMConeOfVisionCustom>();    
			}
		}
