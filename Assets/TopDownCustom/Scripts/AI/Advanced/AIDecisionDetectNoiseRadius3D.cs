...
namespace MoreMountains.TopDownEngine
{
	...
	/// </summary>
	[AddComponentMenu("TopDown Engine/Character/AI/Decisions/AIDecisionDetectNoiseRadius3D")]
	//[RequireComponent(typeof(Character))]
	public class AIDecisionDetectNoiseRadius3D : AIDecision
	{
		...
		protected virtual bool DetectTarget()
		{
			...
			int numberOfCollidersFound = Physics.OverlapSphereNonAlloc(_raycastOrigin, Radius, _hits, TargetLayerMask, QueryTriggerInteraction.Collide);
